package com.bg7yoz.ft8cn.lotwlook;
...
import com.bg7yoz.ft8cn.lotwlook.service.LotwAdifJobService;
...
public class PreferencesActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
        ...
        if (UPDATE_INTERVAL_KEY_NAME.equals(key)) {
            ...
            if (jobScheduler != null) {
                ...
                for (JobInfo job : scheduledJobs) {
                    if (job.getId() == LocalLogManagerActivity.LOTW_UPDATE_JOB_ID) {
                        jobScheduler.cancel(LocalLogManagerActivity.LOTW_UPDATE_JOB_ID);
                        break;
                    }
                }
                if (updateIntervalHours != 0) {
                    ...
                    JobInfo.Builder builder = new JobInfo.Builder(LocalLogManagerActivity.LOTW_UPDATE_JOB_ID, serviceComponent);
    ...
    public static void updateLastQslDate(Context context, long datetimevalue) {
